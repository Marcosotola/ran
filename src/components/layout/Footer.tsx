...
export function Footer() {
  ...
  return (
    <footer className="bg-[#0F1A2E] text-white/80 mt-auto">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Brand */}
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <div className="flex h-9 w-9 items-center justify-center rounded-lg ran-gradient shadow-lg">
                <span className="text-white font-black text-lg leading-none">R</span>
              </div>
              <div>
                <p className="font-bold text-white text-base leading-tight">RAN</p>
                <p className="text-[10px] text-blue-300 leading-tight font-medium tracking-wider uppercase">Pisos & Revestimientos</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="h-9 w-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#3B82C4] transition-colors"
              >
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/como-calcular" className="hover:text-white hover:underline transition-colors">Calculadora de m²</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                <MapPin className="h-4 w-4 text-[#3B82C4] mt-0.5 shrink-0" />
                <span>Buenos Aires, Argentina</span>
              </li>
              <li className="flex items-center gap-2">
                <Phone className="h-4 w-4 text-[#3B82C4] shrink-0" />
                <a href="tel:+5491100000000" className="hover:text-white transition-colors">+54 9 11 0000-0000</a>
              </li>
              <li className="flex items-center gap-2">
                <Mail className="h-4 w-4 text-[#3B82C4] shrink-0" />
                <a href="mailto:info@ranpisos.com.ar" className="hover:text-white transition-colors">info@ranpisos.com.ar</a>
              </li>
            </ul>
          </div>
        </div>
